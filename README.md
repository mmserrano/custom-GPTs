...
[![Made with OpenAI](https://img.shields.io/badge/Made%20with-OpenAI-blue.svg)](https://openai.com)

A collection of specialized AI custom assistants built on chatGPT platform to help in daily tasks an questions.
...
Created by Mariola Martínez

- Email: contacto@aiflow.es
- Portfolio: [aiflow.es](https://aiflow.es)

## 📜 License

This project is licensed under the MIT License - see the individual component directories for specific details.